...
IF(NOT("${FILES_SLICE}" STREQUAL ""))
    ...
    FOREACH(SOURCE_SLICE ${FILES_SLICE})
        ...
        ADD_CUSTOM_COMMAND(
                ...
                COMMAND ${SLICE2CPP_COMMAND} ARGS    ${SOURCE_SLICE_FILENAME} -I${Ice_SLICE_DIR} -I${MODULE_SLICE_DIR} --output-dir ${MODULE_SLICE_DIR}

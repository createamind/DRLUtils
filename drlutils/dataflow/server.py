...
class DataFlowServer(DataPool.Manager):
    def __init__(self, clsPool, val_split = 0.2,
                 rpc_bind = ('127.0.0.1', ICE_RPCIO_LISTEN_PORT_BASE + 10),
                 pool_rpc_port_base = ICE_RPCIO_LISTEN_PORT_BASE + 20,
                 max_caches = 1024,
...
def _processorPool(clsPool, **kwargs):
    ...
    pool = clsPool(initParam.name, initParam.size, initParam.isTrain,
